<div class="container">
    ...
    <form class="ps-checkout__form" action="/pemesanan/update/{{$order->id}}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-8">
                <!-- tambahan -->
                <div class="form-group form-group--inline">
                    ...
                    <select name="namaorder_id" id="namaorder_id" class="form-control">
                        ...
                        <option value="{{$order->harga_order}}" selected>{{$order->nama_order}}</option>
                        @foreach ($products as $row)
                        @if($order->nama_order==$row['nama'])
                        @continue
                        @endif
                ...
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control @error('nama_order') is-invalid @enderror" id="nama_order" name="nama_order" nama="nama_order" placeholder="ini untuk menangkap nama order" value="{{$order->nama_order}}">
                    @error('nama_order')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="harga_order1" name="harga_order1" nama="harga_order1" placeholder="harga order" value="{{$order->harga_order}}" disabled>
                </div>
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control" id="harga_order" name="harga_order" nama="harga_order" placeholder="Harga" value="{{$order->harga_order}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="jumlah_order1" name="jumlah_order1">
                        ...
                        @if($order->jumlah_order==1)
                        <option value="1" selected>1</option>
                        @else
                        <option value="1">1</option>
                        @endif

                        @if($order->jumlah_order==2)
                        <option value="2" selected>2</option>
                        @else
                        <option value="2">2</option>
                        @endif

                        @if($order->jumlah_order==3)
                        <option value="3" selected>3</option>
                        @else
                        <option value="3">3</option>
                        @endif

                        @if($order->jumlah_order==4)
                        <option value="4" selected>4</option>
                        @else
                        <option value="4">4</option>
                        @endif

                        @if($order->jumlah_order==5)
                ...
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control @error('jumlah_order') is-invalid @enderror" id="jumlah_order" name="jumlah_order" nama="harga_order" placeholder="Masukkan Jumlah order" value="{{$order->jumlah_order}}">
                    @error('jumlah_order')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group ">
                    ...
                    <textarea name="address" class="form-control @error('address') is-invalid @enderror" rows="5" placeholder="Alamat Lengkap pengiriman">{{$order->address}}</textarea>
                    @error('address')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group form-group--inline">
                    ...
                    <select name="province_id" id="province_id" class="form-control">
                        ...
                        @if($order->nama_provinsi==$row['province'])
                        <option value="{{$row['province_id']}}" namaprovinsi="{{$row['province']}}" selected>{{$row['province']}}</option>
                        @else
                ...
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control @error('nama_provinsi') is-invalid @enderror" id="nama_provinsi" name="nama_provinsi" nama="nama_provinsi" placeholder="ini untuk menangkap nama provinsi" value="{{$order->nama_provinsi}}">
                    @error('nama_provinsi')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group ">
                    ...
                    <select name="kota_id" id="kota_id" class="form-control">
                        ...
                        <option value="{{$order->nama_kota}}" namakota="{{$row['province']}}" selected>{{$order->nama_kota}}</option>
                    </select>
                </div>
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control @error('nama_kota') is-invalid @enderror" id="nama_kota" name="nama_kota" nama="nama_kota" placeholder="ini untuk menangkap nama kota" value="{{$order->nama_kota}}">
                    @error('nama_kota')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode_pos1" name="kode_pos1" nama="kode_pos1" placeholder="kode pos" value="{{$order->kode_pos}}" disabled>
                </div>
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control" id="kode_pos" name="kode_pos" nama="kode_pos" placeholder="kode pos" value="{{$order->kode_pos}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group ">
                    <label>total berat (gram) </label>
                    <input class="form-control" type="text" id="weight1" name="weight1" value="{{$order->jumlah_order*160}}" disabled>
                </div>
                <div class="form-group ">
                    <!-- hidden -->
                    <input type="text" class="form-control" id="weight" name="weight" value="{{$order->jumlah_order*160}}">
                </div>
                <div class="form-group ">
                    ...
                    <select name="kurir" id="kurir" class="form-control">
                        ...
                        @if($order->nama_kurir=="jne")
                        <option value="jne" selected>JNE</option>
                        @else
                        <option value="jne">JNE</option>
                        @endif
                        @if($order->nama_kurir=="tiki")
                        <option value="tiki" selected>TIKI</option>
                        @else
                        <option value="tiki">TIKI</option>
                        @endif
                        @if($order->nama_kurir=="pos")
                        <option value="pos" selected>POS INDONESIA</option>
                        @else
                ...
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control @error('nama_kurir') is-invalid @enderror" id="nama_kurir" name="nama_kurir" nama="nama_kurir" placeholder="ini untuk menangkap nama kota" value="{{$order->nama_kurir}}">
                    @error('nama_kurir')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <select name="layanan" id="layanan" class="form-control">
                        ...
                        <option value="{{$order->nama_layanan}}" selected>{{$order->nama_layanan}}</option>
                    </select>
                </div>

                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control @error('nama_layanan') is-invalid @enderror" id="nama_layanan" name="nama_layanan" nama="nama_layanan" placeholder="ini untuk menangkap nama kota" value="{{$order->nama_layanan}}">
                    @error('nama_layanan')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Totalan_order1" name="Totalan_order1" nama="Totalan_order1" placeholder="total order" value="{{$order->Totalan_order}}" disabled>
                </div>
                <div class="form-group">
                    <!-- hidden -->
                    <input type="text" class="form-control" id="Totalan_order" name="Totalan_order" nama="Totalan_order" placeholder="total order" value="{{$order->Totalan_order}}">
                </div>

                <div class="form-group">
                    @if($user->id<=2) <label>Update Resi<span>*</span>
                        <input type="text" class="form-control" id="resi" name="resi" nama="resi" placeholder="resi" value="Belum Diupdate">
                        @else
                        <input type="hidden" class="form-control" id="resi" name="resi" nama="resi" placeholder="resi" value="Belum Diupdate">
                        @endif
                </div>
                <div class="form-group">
                    @if($user->id<=2) <label>Update Status Pembayaran<span>*</span>
                        <input type="text" class="form-control" id="status_pembayaran" name="status_pembayaran" nama="status_pembayaran" placeholder="status pembayaran" value="Belum Diupdate">
                        @else
                ...
                <div class="form-group">
                    @if($user->id<=2) <label>Update Status Pengiriman<span>*</span>
                        <input type="text" class="form-control" id="status_pengiriman" name="status_pengiriman" nama="status_pengiriman" placeholder="status pengiriman" value="Belum Diupdate">
                        @else
